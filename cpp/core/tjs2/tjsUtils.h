    ...
    inline void _ensureCapacity()
    {
        if (UnusedIndexStack.empty())
        {
            ...
            if (!PointerBuffPtr)
            {
                ...
                PointerBuffPtr =
                    (_tVectorList_Node*)new char[VECLIST_MIN_CAPACITY * sizeof(_tVectorList_Node)];
            }
            else
            {
                ...
                _tVectorList_Node* newPtr =
                    (_tVectorList_Node*)new char[nNewCapacity * sizeof(_tVectorList_Node)];
...
public:
    ...
    public:
        ...
        const iterator operator++(int _zero)
        { // ++ suffix
            iterator ret = *this;
            if (!end())
            {
